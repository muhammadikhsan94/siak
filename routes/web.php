...
Route::group([
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('t_koperasi', 'HomeController@t_koperasi')->name('t_koperasi');
        Route::get('t_terlapor', 'HomeController@t_terlapor')->name('t_terlapor');
        ...
        Route::middleware('auth.admin')->group(function() {
            Route::post('akuntansi/{id}/verify/data', 'AkuntansiController@verify')->name('akuntansi.verify');
